...
export default function RecentesCategoria () {

  const history = useHistory();

  let variavel = history.location.pathname.replace('/categoria/','');
  let variavelDescricao = history.location.pathname.replace('/categoriaRecentes/','');
  ...
  useEffect (() => {
    async function loadProducts(){
      ...
      try {
        ...
        const response = await getOfertasRecentes(page, (!isEmpty(variavel) && history.location.pathname !== variavel ? 'categoria' : 'categoriaRecentes'), (!isEmpty(variavel) && history.location.pathname !== variavel ? variavel : variavelDescricao)); 
