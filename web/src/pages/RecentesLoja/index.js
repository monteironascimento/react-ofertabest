...
export default function RecentesLoja () {

  const history = useHistory();

  let { uid, description } = useParams();
  ...
  async function loadProducts(){
    ...
    try {
      ...
      const response = await getOfertasRecentes(page, (!isEmpty(uid) ?  'loja' : 'loja-recente'), (!isEmpty(uid) ?  uid : description)); 
