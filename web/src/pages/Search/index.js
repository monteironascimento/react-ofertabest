...
export default function Search () {
  ...
  async function loadProducts(pagefixa){
    ...
    try {
        ...
        const response = await getOfertasRecentes(page, 'search', description); 
     
        if(isEmpty(response)){
          
          //showToast({ type: "warn", message: "Consulta não encontrada!" })
